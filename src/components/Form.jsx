            ...
            <div className="information text-center">
                ...
                <div className="mt-5">
                    <form action="" method="get">
                        ...
                        <input className="form-control place" type="text" name="query" id="query" placeholder={lang("form.placeholder")} required></input><br />
                        <button type="sumbit" className="btn btn-info">{lang("form.button.search")}</button>
                    </form>
                    <br />
                    <form action="" method="get">
                        <input type="text" name="query" id="query" value="0" readOnly hidden></input>
